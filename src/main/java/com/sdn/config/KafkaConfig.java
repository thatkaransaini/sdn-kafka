...
import com.sdn.consumers.KafkaConsumerA;
import com.sdn.consumers.KafkaConsumerB;
import com.sdn.consumers.KafkaConsumerC;
...
public class KafkaConfig {
	 ...
	 @Bean
	    public KafkaConsumerA listener() {
	        return new KafkaConsumerA();
	    }
	 
	 @Bean
	    public KafkaConsumerB listener1() {
	        return new KafkaConsumerB();
	    }
	 @Bean
	    public KafkaConsumerC listener2() {
	        return new KafkaConsumerC();
	    }
